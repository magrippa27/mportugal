...
const translations: Record<Language, Record<string, string>> = {
  ...
  pt: {
    ...
    'nav.tobacco': 'Tabaco',
    'site.title': 'Manuel de Portugal',
    'site.tagline': 'Autor e investigador em comunicação por rádio e estudos do tabaco',
    'home.latestPosts': 'Últimas Publicações',
    'home.featuredBooks': 'Livros em Destaque',
    'home.aboutTeaser': 'Saiba mais sobre o meu trabalho',
    'home.viewAllPosts': 'Ver todas as publicações',
    'home.viewAllBooks': 'Ver todos os livros',
    'home.radioCard.title': 'Rádio',
    'home.radioCard.description': 'Explore rádio amador, comunicação e tópicos relacionados',
    'home.tobaccoCard.title': 'Tabaco',
    'home.tobaccoCard.description': 'História profissional do tabaco, ciência e investigação',
    'books.title': 'Livros',
    'books.download': 'Descarregar',
    'books.category.radio': 'Livros de Rádio',
    'books.category.tobacco': 'Livros de Tabaco',
    'books.category.other': 'Outros Livros',
    'books.relatedBooks': 'Livros Relacionados',
    'books.publicationDate': 'Publicado',
    'blog.title': 'Blog',
    'blog.category.all': 'Todos',
    'blog.category.radio': 'Rádio',
    'blog.category.tobacco': 'Tabaco',
    'blog.category.tools': 'Ferramentas',
    'blog.category.veterinary': 'Veterinária',
    'blog.category.other': 'Outros',
    'blog.categories': 'Categorias',
    'blog.readMore': 'Ler mais',
    'blog.backToBlog': 'Voltar ao Blog',
    'blog.relatedPosts': 'Publicações Relacionadas',
    'blog.postsInCategory': 'Publicações na categoria',
    'radio.title': 'Rádio',
    'radio.intro': 'Explorando o fascinante mundo do rádio amador e da tecnologia de comunicação.',
    'radio.booksSection': 'Livros de Rádio',
    'radio.articlesSection': 'Artigos de Rádio',
    'tobacco.title': 'Tabaco',
    'tobacco.intro': 'Perspetivas profissionais sobre a história, ciência e indústria do tabaco.',
    'tobacco.booksSection': 'Livros de Tabaco',
    'tobacco.articlesSection': 'Artigos de Tabaco',
    'footer.copyright': 'Todos os direitos reservados',
    'about.title': 'Sobre',
    'station.callsigns': 'Indicativos Principais',
    'station.equipment': 'Equipamento da Estação',
    'station.location': 'Localização de Operação',
    'station.transceiver': 'Transceptor',
    'station.antennas': 'Antenas',
    'station.power': 'Potência',
    'station.qth': 'QTH',
    'station.locator': 'Localizador de Grelha',
    'station.class': 'Classe de Licença',
    'station.coordinates': 'Coordenadas',
  },
};
